...
App: Cens Verantwortliche Stelle: Kantonsschule Uetikon am See (KUE), Bergstrasse 113, 8707 Uetikon am See Entwickler: Nikola Jovanov, kue.it@kuezh.ch Stand: 20. August 2026
...
Konfigurationsdaten wie Schul-Standort (für die Schuljahrsberechnung), bevorzugte Fachschaft (pro iPad), Mailserver-Einstellungen (Host, Port, Benutzername) sowie eine optionale Liste interner E-Mail-Adressen, die eine Kopie der Schlüssel-Übergabequittungen erhalten (siehe 4.3). Das Mailserver-Passwort wird ausschliesslich im Apple-Keychain gespeichert und nie ins Aktivitätsprotokoll oder in die Cloud synchronisiert.
...
Optional: E-Mail-Adresse (für die Übergabequittung und Rückgabe-Erinnerungen), Asset-Typ (Schlüssel/Badge/PIN), Schließgruppe, Ausgabe-/Rückgabedatum, Status, Lagerort
...
Falls in den Einstellungen ein Mailserver hinterlegt ist, versendet die App Übergabequittungen, Rückgabe-Erinnerungen und Mahnungen an die in den Ausleih- bzw. Schlüsseldaten erfassten E-Mail-Adressen. Die E-Mails enthalten: Geräte- bzw. Schlüsselbezeichnung, Inventarnummer bzw. Schließgruppe, Rückgabedatum, Name der betroffenen Person. Tür-/PIN-Codes werden nie per E-Mail versendet.

Kopie der Schlüssel-Übergabequittung: Die KUE kann in den Einstellungen interne E-Mail-Adressen hinterlegen, die von jeder Schlüssel-Übergabequittung eine inhaltsgleiche Kopie erhalten. Zweck ist die Bewirtschaftung des Schlüsselbestands durch die dafür zuständige Stelle (Hausdienst/Schlüsselverwaltung). Die Kopie enthält dieselben Angaben wie die Quittung an die betroffene Person, insbesondere deren Namen; Tür-/PIN-Codes sind auch hier nicht enthalten. Betroffen ist ausschliesslich die Übergabequittung — Rückgabe-Erinnerungen und Mahnungen werden nicht kopiert. Ist die Liste leer, wird keine Kopie versendet. Der Versand erfolgt direkt vom iPad an den von der KUE festgelegten SMTP-Server über eine verschlüsselte Verbindung (STARTTLS). Es wird kein externer E-Mail-Dienstleister eingebunden.
...
Interne Schlüsselverwaltung: Erhält, sofern in den Einstellungen hinterlegt, eine Kopie jeder Schlüssel-Übergabequittung (Punkt 4.3).
...
Aktivitätsprotokolle werden 90 Tage aufbewahrt und danach automatisch gelöscht. Forensische Nachweis-Einträge (Massen-Löschung, Daten-Wiederherstellung, Anonymisierung) werden zu Aufklärungs- und Nachweiszwecken 2 Jahre aufbewahrt.
...
Kantonsschule Uetikon am See Bergstrasse 113, 8707 Uetikon am See

Technischer Kontakt: Nikola Jovanov kue.it@kuezh.ch
